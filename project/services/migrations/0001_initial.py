    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_customer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='customers.customer', verbose_name='customer')),
                ('id_service', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='services.service', verbose_name='service')),
